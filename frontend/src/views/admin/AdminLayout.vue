    ...
    <aside class="sidebar">
      ...
      <nav class="nav">
        <RouterLink
          :to="{ name: 'admin-home' }"
          class="nav-btn"
          :class="{ active: $route.name === 'admin-home' }"
          replace
        >
          Inicio
        </RouterLink>
        ...
        <RouterLink
          :to="{ name: 'admin-gestionarstafs' }"
          class="nav-btn"
          :class="{ active: $route.name === 'admin-gestionarstafs' }"
          replace
        >
          Gestionar usuarios
        </RouterLink>
        ...
        <RouterLink
          :to="{ name: 'admin-cursos' }"
          class="nav-btn"
          :class="{ active: $route.name === 'admin-cursos' }"
          replace
        >
          Gestionar Cursos
        </RouterLink>
        ...
        <RouterLink
          ...
          class="nav-btn"
          :class="{ active: $route.name === 'admin-supervision' }"
          replace
        >
          Supervisión General
        </RouterLink>
        ...
        <RouterLink
          :to="{ name: 'admin-formatos' }"
          class="nav-btn"
          :class="{ active: $route.name === 'admin-formatos' }"
          replace
        >
          Formatos de correo
        </RouterLink>
...
.admin-home { display: flex; align-items: center; justify-content: center; height: calc(100vh - 4rem); }
